A resolução do Orienteering Problem (OP) está diretamente relacionada à proposta central do projeto, 
que consiste em modelar e resolver um problema de planejamento de rotas para um robô em ambiente de resgate e exploração.
...
Isso torna possível apoiar o planejamento de missões do robô de forma mais eficiente, 
segura e com melhor aproveitamento de recursos energéticos.
